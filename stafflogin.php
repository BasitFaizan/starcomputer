...
if (isset($_POST['login'])) {
    ...
    $conn = mysqli_connect("localhost", "basitfaizan786@gmail.com", "12345678", "parwezAlam");

    if (!$conn) {
        die("Connection failed: " . mysqli_connect_error());
    }
    $query = "SELECT staffName, staffEmail, staffPassword FROM staffLogin WHERE staffEmail = ?";
                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Staff Log in</p>
