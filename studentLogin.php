...
if (isset($_POST['upload'])) {
    ...
    if ($password == $cPassword) {
        ...
        $insertQuery = "INSERT INTO `studentLogin` (`studentName`, `studentEmail`,`studentNumber`, `studentPassword`, `studentCertificate`) VALUES ('$name', '$email', '$number', '$hashedPassword', '$studentCertificate')";
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <form class="mx-1 mx-md-4" method='post' enctype="multipart/form-data">
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="number" name="number" id="form3Example3c"
                                                    class="form-control" />
